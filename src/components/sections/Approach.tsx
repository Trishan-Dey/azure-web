    ...
    >
      ...
      >
        ...
        <div className="flex h-full w-screen shrink-0 flex-col justify-center px-6 sm:px-16">
          ...
          <h2 className="font-display text-[12vw] font-extrabold uppercase leading-[0.9] tracking-tight sm:text-[6vw]">
            How we
            <br />
            <span className="text-deepazure">work.</span>
          </h2>
          <p className="mt-6 max-w-xs text-sm text-midnight/60">
        ...
        {STEPS.map((s) => (
          ...
          >
            <div className="flex items-baseline gap-4">
              ...
              <h3 className="font-display text-[16vw] font-black uppercase leading-none tracking-tight sm:text-[9vw]">
                {s.word}
        ...
        {/* End panel */}
        <div className="flex h-full w-screen shrink-0 flex-col justify-center px-6 sm:px-16">
          <h3 className="font-display text-[10vw] font-extrabold uppercase leading-[0.9] tracking-tight sm:text-[5vw]">
            Then we
            <br />
